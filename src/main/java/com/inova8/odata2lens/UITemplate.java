...
public class UITemplate {
	...
	public void updateProperty(String property, String propertyType, String range, Float ordinal, Boolean visible,
			String aggregate, String formatOptions, String height, String style,Boolean nullable, String IRI, String inverseProperty) {
		...
		if (ordinal != null) {
			...
			if (currentOrdinal != null && currentTemplate != null) {
				PropertyTemplate propertyTemplate = new PropertyTemplate(property,
						...
						(IRI == null) ? currentTemplate.getIRI() : IRI,
						(inverseProperty == null) ? currentTemplate.getInverseProperty() : inverseProperty
			...
			for (PropertyTemplate propertyTemplate : properties.values()) {
				if (propertyTemplate.getProperty().equals(property)) {
					propertyTemplate.update(property, propertyType, range, ordinal, visible, aggregate, formatOptions, height,style,nullable,IRI,inverseProperty);
					break;
				}
			}
		}
