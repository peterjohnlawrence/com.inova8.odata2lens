...
public class NavigationProperty {
	...
	public NavigationProperty(String name, String label, String tooltip, String targetEntityType, String range,
			String icon, String height, String style, Boolean nullable,Boolean isReifiedSubject,Boolean isReifiedObject,Boolean isReifiedPredicate, String IRI, String inverseProperty) {
		this.name = name;
		this.label = label;
